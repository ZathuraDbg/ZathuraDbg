...
extern bool breakpointsUI;
extern bool watchpointsUI;
extern bool stateChangesUI;
...
extern void remoteSourceWindow();
extern void breakpointManagerWindow();
extern void watchpointWindow();
extern void stateChangesWindow();
...
extern void setRemoteSourceFile(const std::string& path);
extern void clearRemoteSourceFile();
extern void addRemoteSourcePathRemap(const std::string& from, const std::string& to);
extern void clearRemoteSourcePathRemaps();
extern std::string applyRemoteSourcePathRemaps(const std::string& path);
#endif
