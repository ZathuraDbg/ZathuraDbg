...
static bool TokenizeX86_64StylePunctuation(const char *in_begin, const char *in_end, const char *&out_begin, const char *&out_end) {
    (void) in_end;
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Asmx86_64() {
    ...
    if (!inited) {
        static const char *const keywords[] = {
                ...
                "cpu_write", "cwd", "cwde", "daa", "das", "dec", "div", "emms", "enter", "f2xm1",
        ...
        langDef.mTokenize = [](const char *in_begin, const char *in_end, const char *&out_begin, const char *&out_end,
            ...
            else if (TokenizeX86_64StylePunctuation(in_begin, in_end, out_begin, out_end))
...
//      for nasm
        ...
        langDef.mName = "Intel x86_64 Assembly";
